...
//    }
    ...
    @After("execution(* workshop.test05.Student.homework(..))")
    ...
    @Pointcut("execution(* workshop.test05.Student.*(..))")
    public void allMethods(){}// 가안으로 대처할 수 있는 포인트 컷이 있는 메소드를 만들어 준다.

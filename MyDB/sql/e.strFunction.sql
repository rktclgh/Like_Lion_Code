...
-- ex): 'SMITH-CLERK', 'ALLEN-SALESMAN', ...
    select upper(concat(ename,'_',job ))
    from emp;
...
SELECT LOAD_FILE('/opt/homebrew/var/mysql/uploads/1.png');
SELECT LOAD_FILE('/opt/homebrew/var/mysql/uploads/a.txt');
...
CREATE TABLE MY_FILE(
    ...
    name varchar(20),
    file_content longtext # NO_AUTO_VALUE_ON_ZERO, PRIMARY KEY(U+N)
);
...
desc MY_FILE;
    ...
    insert into my_file values('A','2');
...
INSERT INTO MY_FILE(FILE_CONTENT)  
  VALUES(LOAD_FILE('/opt/homebrew/var/mysql/uploads/a.txt'));
...
#   VALUES(LOAD_FILE('/opt/homebrew/var/mysql/uploads/a.txt')),
        values (LOAD_FILE('/opt/homebrew/var/mysql/uploads/1.png'));
...
SELECT ENAME
FROM TEST
ORDER BY ENAME COLLATE utf8mb4_unicode_ci;      # unicode_language_id <- 얘로 다 된다!

...
public class ReduceTest02 {
    ...
    public static void main(String[] args) {
        System.out.println("Q1. {3, 7, 2, 9, 5, 8}에서 reduce()를 사용하여 최댓값을 구해보자");
        ...
        Integer res03 = numbers4.stream().map(e -> e * e).reduce(0, Integer::sum);
        ...
        Integer res04 = words5.stream().map(String::length).reduce(0, Integer::sum);
